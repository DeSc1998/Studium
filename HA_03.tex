...
\section{Aufgabe 1}
\label{sec:orgb0afcea}
\subsection{a)}
\label{sec:orga71de84}
\subsubsection{z\textsubscript{1}}
\label{sec:orge8ef85c}
\begin{equation}
\begin{aligned}
z_1 &= 4e^{-\frac{\pi}{6}i}
...
\subsection{b)}
\label{sec:org5ed49de}
\subsubsection{z\textsubscript{1}}
\label{sec:orgeb1d5c7}
$$r^2 = (-3)^2 + (-3)^2 = 18$$
$$\tan(\phi) = \frac{-3}{-3}$$
...
\section{Aufgabe 2}
\label{sec:org9939929}
\subsection{a)}
\label{sec:org9e7a244}
...
\section{Aufgabe 4}
\label{sec:orga7e080d}
\subsection{a)}
\label{sec:org34ce797}
...
\section{Aufgabe 5}
\label{sec:orgbd49d2c}
\subsection{a)}
\label{sec:org27045ee}
...
\section{Aufgabe 6}
\label{sec:org5c768bb}
\subsection{a)}
\label{sec:org9aa532e}
