...
\section{Aufgabe 1}
\label{sec:orgdee5373}
\subsection{a)}
\label{sec:org548e37b}
\subsubsection{z\textsubscript{1}}
\label{sec:org574e07d}
\begin{equation}
\begin{aligned}
z_1 &= 4e^{-\frac{\pi}{6}i}
...
\subsection{b)}
\label{sec:orgdeed5e8}
\subsubsection{z\textsubscript{1}}
\label{sec:org21537d6}
$$r^2 = (-3)^2 + (-3)^2 = 18$$
$$\tan(\phi) = \frac{-3}{-3}$$
...
\section{Aufgabe 2}
\label{sec:orgbce6957}
\subsection{a)}
\label{sec:org269300d}
...
\section{Aufgabe 4}
\label{sec:org61b0ad8}
\subsection{a)}
\label{sec:org382c78c}
...
Wie in 3b) sind die "Gleichungen" nur repräsentativ für die einzelnen Schritte der Polynomdivision.
...
\section{Aufgabe 5}
\label{sec:orgffbf72b}
\subsection{a)}
\label{sec:org58e4be9}
...
\section{Aufgabe 6}
\label{sec:org60953cc}
\subsection{a)}
\label{sec:org0fa4dcc}
...
Die folgenden "Gleichungen" sind hier wieder repräsentativ für die Schritte.
...
Es können keine weiteren Schritte durchgeführt werden, weil \(deg(x - 1) < deg(q)\). Womit gilt \(q \nmid p\), da ein Restpolynom übrig bleibt.
...
A\textsubscript{1} muss über einen Koeffizientenvergleich ermittelt werden.
