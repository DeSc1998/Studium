...
\section{Aufgabe 1}
\label{sec:org99e5ecb}
\subsection{a)}
\label{sec:org4bbeaa2}
...
\section{Aufgabe 2}
\label{sec:org50505f5}
\subsection{a) und c)}
\label{sec:org05ddcd3}
\begin{align*}
    x_1 & = \underline{1},2 \\
...
\section{Aufgabe 5}
\label{sec:orgbb2d93f}
\subsection{a)}
\label{sec:org459b6b1}
