...
\date{\today}
\title{Analysis I und Lineare Algebra für Ingenieurwissenschaften \large  \\ Hausaufgabe 08 - Geuter 29}
\hypersetup{
 pdfauthor={Moaz Haque, Felix Oechelhaeuser, Leo Pirker, Dennis Schulze},
 pdftitle={Analysis I und Lineare Algebra für Ingenieurwissenschaften \large  \\ Hausaufgabe 08 - Geuter 29},
 pdfkeywords={},
 pdfsubject={},
...
\section{Aufgabe 1}
\label{sec:orgff68a13}
\subsection{a)}
\label{sec:orgb876149}
...
\section{Aufgabe 2}
\label{sec:org1433db0}
\subsection{a) und c)}
\label{sec:org8d42d8f}
\begin{align*}
    x_1 & = \underline{1},2 \\
...
\section{Aufgabe 5}
\label{sec:org09b0239}
\subsection{a)}
\label{sec:orgc44be80}
...
was \textbf{eine} Lösung der ursprünglichen Differenzialgleichung ist.

\pagebreak

\section{Aufgabe 6}
\label{sec:orgc928a0e}
