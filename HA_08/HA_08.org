...
Damit gilt dann auch $g(t) = 0$, für alle $t \in \mathbb{R}$.
...
Für das Restglied $R_1$ gilt

$$ R_1(x) > 0, \forall x \in ]0, \infty[ \text{ mit } \xi = 0 $$

Daraus folgt $T_1(x) > f(x)$ für alle $x$ \in ]0, \infty[.

und es gilt für das Restglied $R_2$

$$ R_2(x) < 0, \forall x \in ]0, \infty[ \text{ mit } \xi = 0 $$

daraus folgt wiederum $T_2(x) < f(x)$ für alle $x$ \in ]0, \infty[.

Damit gilt

\begin{align*}
  & T_1(x) > f(x) > T_2(x) \\
\Leftrightarrow & x > \ln(1 + x) > x - \frac{x^2}{2}, \text{ für } x \in ]0, \infty[
\end{align*}
