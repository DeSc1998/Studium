...
\section{Aufgabe 2}
\label{sec:orgd232184}
\subsection{a)}
\label{sec:org11175f7}
Zu zeigen ist
...
\section{Aufgabe 4}
\label{sec:orgfca0bec}
\subsection{a)}
\label{sec:org962de50}
\begin{align*}
  \sqrt{4^{3(x-2)}} &= 16^{1-x} \\
...
\section{Aufgabe 5}
\label{sec:orgac4a29a}
\subsection{a)}
\label{sec:org2880918}
\subsection{b)}
\label{sec:org8cc0cdb}
\section{Aufgabe 6}
\label{sec:org00bb8a5}
\subsection{a)}
\label{sec:org1ba5c35}
Es gilt
...
\section{Aufgabe 7}
\label{sec:orgdd5cf92}
\subsection{a)}
\label{sec:orgf81749b}
\begin{align*}
